    ...
    # Get counts of all faces and suits. 
        ...
        for i in range(0, 10): 
             ...
             counts[straightrunfaces[i+3]]):
                        ...
                        suits = 'SCDH'
                        for ch in suits:
                                if      straightrunfaces[i] in suit_count[ch] and straightrunfaces[i+1] in suit_count[ch] and straightrunfaces[i+2] in suit_count[ch] and straightrunfaces[i+3] in suit_count[ch]:
                                        is_4straight = True
                                        break           
 	for i in range(0, 10): 
             ...
             counts[straightrunfaces[i+4]]):
                        ...
                        suits = 'SCDH'
                        for ch in suits:
                                if      straightrunfaces[i+1] in suit_count[ch] and straightrunfaces[i+2] in suit_count[ch] and straightrunfaces[i+3] in suit_count[ch] and straightrunfaces[i+4] in suit_count[ch]:
                                        is_4straight = True
                                        break           
